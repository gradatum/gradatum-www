...
const versions: VersionPhase[] = [
  ...
  },
  {
    ...
    scopeTeaserItems: ['Health observability (/health)', 'Rust 2024 edition', 'Knowledge-base surface hardening'],
    featureRefs: [],
    showFeaturesLink: false,
  },
  {
    ...
    scopeTeaserItems: ['Native MCP server', 'Streamable HTTP transport (MCP spec 2025-11)', 'Write-time schema validation + auto-repair', 'Vault audit & deduplication'],
  ...
  },
  {
    ...
    scopeTeaserItems: ['Context builder', 'Sliding-window memory', 'Proactive recall', 'User profile (declarative)', 'Skill selection'],
  ...
  },
  {
    ...
    scopeTeaserItems: ['gradatum-code agentic core', 'Symbol + diff-aware context', 'Project history recall', 'Local-only execution (zero cloud upload)', 'Task execution loop'],
    featureRefs: [],
    showFeaturesLink: false,
  },
  {
    ...
    scopeTeaserItems: ['Stable API — semver guarantees', 'Local ONNX privacy filter', '30-day production proof', 'Full LongMemEval reproducible', 'Multi-user + OAuth remote access'],
  ...
  },
  {
    ...
    scopeTeaserItems: ['Multimodal chat (BREAKING)', 'Memory consolidation'],
    featureRefs: ['F-49'],
    showFeaturesLink: false,
  },
];
